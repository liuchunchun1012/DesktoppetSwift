...
class ChatLogManager: ObservableObject {
    ...
    // ~/Library/Mobile Documents/com~apple~CloudDocs/Meowpal/ChatLogs/
    private var storageDirectory: URL {
        let homeDir = fileManager.homeDirectoryForCurrentUser
        let iCloudDocs = homeDir
            .appendingPathComponent("Library/Mobile Documents/com~apple~CloudDocs/Meowpal/ChatLogs")
    ...
    private var localFallbackDirectory: URL {
        ...
        let appFolder = appSupport.appendingPathComponent("Meowpal/ChatLogs", isDirectory: true)
